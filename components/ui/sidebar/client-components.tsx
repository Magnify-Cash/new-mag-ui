...
export function ClientDropdown({ trigger, children, align = "start", className }: DropdownProps) {
  return (
    <DropdownMenu.Root>
...
export const ClientMenuItem = React.forwardRef<HTMLButtonElement, MenuItemProps>(
