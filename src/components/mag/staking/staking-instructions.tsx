    ...
    <Card className="p-6">
      ...
      <Accordion type="single" collapsible>
        <AccordionItem value="step-1">
          ...
          <AccordionContent>
            Click the "Connect Wallet" button in the top right corner and select
        ...
        <AccordionItem value="step-2">
          ...
          <AccordionContent>
            Enter the amount of MAG you want to stake. Remember the minimum is
            100 MAG.
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="step-4">
          ...
          <AccordionContent>
            Once confirmed, your MAG will be staked and you'll start earning
            rewards immediately.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
